          ...
          <div className="card shadow mb-4">
            <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 className="m-0 font-weight-bold text-primary">
                {t("create_product.create_parcel")}
              </h6>
              {/*  <h6 className="m-0 font-weight-bold text-primary">
                        ...
                        <>
                          ...
                          <div className="col-sm-6  col-md-6 col-lg-6">
                            ...
                            <input
                              ...
                              className="form-control form-control-user"
                              id="wide_size"
                              placeholder={`${t("create_product.width_size")} ${
                                index + 1
                              }`}
                              name="wide_size"
                          ...
                          <div className="col-sm-6  col-md-6 col-lg-6 mt-3">
                            ...
                            <input
                              ...
                              className="form-control form-control-user"
                              id="long_size"
                              placeholder={`${t("create_product.the_length")} ${
                                index + 1
                              }`}
                              name="long_size"
                          ...
                          <div className="col-sm-6  col-md-6 col-lg-6  mt-3">
                            ...
                            <input
                              ...
                              className="form-control form-control-user"
                              id="height_size"
                              placeholder={`${t("create_product.height")} ${
                                index + 1
                              }`}
                              name="height_size"
                          ...
                          <div className="form-group row mt-3">
                            <div className="col-sm-6  col-md-6 col-lg-6 mb-3 mb-sm-0">
                              ...
                              <input
                                ...
                                placeholder={`${t("create_product.cue")} ${
                                  index + 1
                                }`}
                            ...
                            <div className="col-sm-6  col-md-6 col-lg-6 mt-3">
                              <label
                                ...
                                className="form-label"
                              >
                                {t("create_product.total_weigh")} {index + 1}
                              </label>
                              <input
                                type="text"
                                className="form-control form-control-user"
                    ...
                    <div className="form-group row">
                      <div className="col-sm-6  col-md-6 col-lg-6 mb-3 mb-sm-0">
                        ...
                        <select
                          ...
                          aria-label="Default select example"
                        >
                          <option>{t("create_product.select_parcel")}</option>
                          {userCode &&
                            userCode
                              .filter(
                                (type) =>
